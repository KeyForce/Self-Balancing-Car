...
void enable_irq (int irq)//主要是使能NVIC嵌套中断的设置
{
    int div;
...
void set_irq_priority (int irq, int prio)//设置中断优先级
{
